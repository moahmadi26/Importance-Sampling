N = 15;
pmat = load('./yeast_Bin_10_to_200_N_15/p.mat');
p = pmat.p;

tmat = load('./yeast_Bin_10_to_200_N_15/t.mat');
t = tmat.t;

vmat = load('./yeast_Bin_10_to_200_N_15/v.mat');
v = vmat.v;
...
hold on
plot(x(1:2:end), yeastTrue(1:2:end), 'lineWidth', 2)
hold on
