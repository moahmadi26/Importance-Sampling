N = 15;
pmat = load('./0x8E_bin_10_5_200_N_15/p.mat');
p = pmat.p;

tmat = load('./0x8E_bin_10_5_200_N_15/t.mat');
t = tmat.t;

vmat = load('./0x8E_bin_10_5_200_N_15/v.mat');
v = vmat.v;
...
hold on
plot(x(1:2:end), circuitTrue(1:2:end), 'lineWidth', 2)
hold on
