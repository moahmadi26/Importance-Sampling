...
delta = 0.8; %close to optimal for this scheme by running 4000 wSSA for delta in [0.05, 0.05, 1.5]
alph = ones(19,1);
% alph(1) = 1/delta;
% alph(2) = delta;
% alph(4) = delta;
...
gamma_max_temp = 3.25; %close to optimal for this scheme by running 5000 swSSA for gamma in [1, 0.25, 5]
gamma_max = ones(19,1);
