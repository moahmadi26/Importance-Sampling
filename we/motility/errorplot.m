N = 100;
pmat = load('./motility_bin_10_5_200_N_100/p.mat');
p = pmat.p;

tmat = load('./motility_bin_10_5_200_N_100/t.mat');
t = tmat.t;

vmat = load('./motility_bin_10_5_200_N_100/v.mat');
v = vmat.v;
...
hold on
plot(x(1:2:end), motilTrue(1:2:end), 'lineWidth', 2)
hold on
